...
#-------------------------------------------------------------------------------------------------------------------------
    def tombol_click_keberangkatan(self):
        ...
        self.open_button1.place(x=287, y=103)
        # self.open_button.place(x=1000, y=10)
        self.move_button.place(x=1000, y=50)
        self.tree.place(x=330, y=100, width=790, height=450)

        self.Sort_button = ttk.Button(self,text="Sorting",command=self.sorting2)
        self.Sort_button.place(x=900, y=30)
    ...
    def move_selected_row(self):
        ...
        if move == True:
            ...
            last_column_value = self.cabang_tujuana(row_values)
    ...
    def cabang_tujuana(self, row_values):
        if row_values:
            return row_values[-1]  
        return None
...
#------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    def tombol_click_kedatangan(self):
        ...
        self.tree = ttk.Treeview(self)
        self.open_button = Button(self,image=self.photo_load_treeview, command=self.openFile_kedatangan, bg='#FEF7E4', bd=0, activebackground='#FEF7E4',cursor='hand2')
        self.move_button = ttk.Button(self, text="Move Selected Row", command=self.move_selected_row1)
        self.kembali_merah_9_button = Button(self, image=self.photo_kembali_merah_8, command=self.tombol_click_pemantauan, bd=0, bg='#FEF7E4', activebackground='#FEF7E4',cursor='hand2')
            
        self.kembali_merah_9_button.place(x=1170, y=50)
        self.open_button.place(x=287, y=103)
        self.move_button.place(x=1000, y=50)
        self.tree.place(x=330, y=100, width=790, height=450)

        self.Sort_button = ttk.Button(self,text="Sorting",command=self.sorting1)
        self.Sort_button.place(x=900, y=30)
    ...
    def move_selected_row1(self):
        ...
        #     last_column_value = self.cabang_tujuana1(row_values)
        #     target_file_path2 = f'database/{last_column_value}/package_out.csv'

        #     # Move row to target CSV file
        #     with open(target_file_path2, 'a', newline='') as file:
        #         csvwriter = csv.writer(file)
        #         csvwriter.writerow(row_values)
    ...
    def cabang_tujuana1(self, row_values):
        if row_values:
            return row_values[-1] 
        return None
